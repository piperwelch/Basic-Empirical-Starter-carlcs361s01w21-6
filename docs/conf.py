...
breathe_projects = {
    "Anya Vostinar": "./doxyoutput/xml"
}
breathe_default_project = "Anya Vostinar"
...
project = u'Evolutionary Algorithm'
...
latex_documents = [
    (master_doc, 'evo-algo.tex',
     u'Evolutionary Algorithm Documentation',
     u'Anya Vostinar', 'manual'),
]
